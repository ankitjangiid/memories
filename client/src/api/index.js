...
export const forgot_password = (email) => API.post("/user/forgot_password", { email });
export const getUserByToken = (token) => API.post("/user/getUserByToken", { token });
export const reset_password = (password, token) =>
  API.post(`/user/reset_password/${token}`, { password });
